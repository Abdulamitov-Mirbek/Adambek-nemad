...
// ПОМЕНЯЛ МЕСТАМИ: 1-е и 3-е видео поменяны местами
const videos = [
  {
    url: "https://www.youtube.com/watch?v=crIz4zyNaww", // Было 3-е, теперь 1-е
    duration: "25:30",
    date: "2023-10-11",
    views: "423",
  ...
  {
    url: "https://www.youtube.com/watch?v=P9iC49k2Q80", // Было 1-е, теперь 3-е
    duration: "14:12",
    date: "2024-03-01",
    views: "1.3K",
    customThumb: null,
    ...
    <section id="press" className="relative py-32 overflow-hidden bg-black">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20">
        ...
        <div className="relative group">
          ...
          <div
            ref={scrollRef}
            className="flex gap-8 overflow-x-auto pb-6 no-scrollbar snap-x snap-mandatory lg:grid lg:grid-cols-3 lg:overflow-visible lg:justify-items-center lg:max-w-6xl lg:mx-auto"
          >
            {cards.map((v, idx) => (
              <motion.div
                key={idx}
              ...
              >
                <div className="bg-white/5 border border-white/10 rounded-3xl overflow-hidden transition-all duration-500 hover:border-blue-500/30 hover:shadow-xl hover:shadow-blue-500/10">
                  <div className="relative aspect-video overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative">
                        ...
                        <div className="relative w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform">
                          <PlayIcon
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-white/10">
                      <span className="text-sm font-bold text-blue-400 hover:text-blue-300 transition-colors">
                        {t.watchNow}
                      </span>
                      <div className="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center hover:bg-blue-500/30 transition-colors">
                        <PlayIcon
                          className="w-4 h-4 text-blue-400 ml-0.5"
                          fill="currentColor"
                        />
                      </div>
                    </div>
        ...
        {selectedVideo && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="relative w-full max-w-5xl aspect-video bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-3xl overflow-hidden shadow-2xl border border-white/20"
              onClick={(e) => e.stopPropagation()}
            >
              <button
                onClick={() => setSelectedVideo(null)}
                className="absolute top-4 right-4 z-10 p-2 bg-black/50 text-white rounded-full hover:bg-black/70 transition-colors backdrop-blur-sm"
              >
                <CloseIcon />
              </button>
              <iframe
