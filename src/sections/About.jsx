...
const content = {
  ru: {
    ...
    description1:
      "17 лет в продажах. Один из ведущих тренеров по продажам в Кыргызстане. За годы работы помог более чем 1000 предпринимателям и менеджерам увеличить оборот своих компаний в 2–3 раза.",
    description2:
      "Победитель премии «Лучший бизнес-тренер 2023». Наставник для предпринимателей, руководителей и экспертов, которые хотят выстроить сильную систему продаж, эффективно управлять командой и стабильно увеличивать прибыль.",
    description3:
      "Если вы продаёте через скидки, часто слышите «дорого» или «я подумаю», проводите много встреч без результата, испытываете сложности с управлением отделом продаж или хотите вывести свой бизнес на новый уровень — я помогу вам построить систему, которая приносит стабильные продажи и рост дохода.",
    statsTitle: "В цифрах:",
    stat1: "17 лет опыта",
    stat2: "1000+ учеников",
    stat3: "90% результат",
  ...
  kg: {
    ...
    titleGradient: "НЕЕМАТ",
    description1:
      "Сатууда 17 жыл. Кыргызстандагы алдыңкы сатуу боюнча тренерлердин бири. Иш учурунда 1000ден ашык ишкерлерге жана менеджерлерге өз компанияларынын жүгүртүүсүн 2–3 эсеге көбөйтүүгө жардам берген.",
    description2:
      "«2023-жылдын мыкты бизнес-тренери» сыйлыгынын жеңүүчүсү. Күчтүү сатуу системасын түзүүнү, команданы натыйжалуу башкарууну жана туруктуу кирешени көбөйтүүнү каалаган ишкерлердин, жетекчилердин жана эксперттердин насаатчысы.",
    description3:
      "Эгер сиз арзандатуулар аркылуу сатасызбы, көп учурда «кымбат» же «ойлоном» деген жоопторду угасызбы, натыйжасыз көп жолугушууларды өткөрөсүзбү, сатуу бөлүмүн башкарууда кыйынчылыктарга дуушар болосузбу же бизнесиңизди жаңы деңгээлге чыгарууну каалайсызбы — мен сизге туруктуу сатууну жана кирешенин өсүшүн камсыз кылган системаны түзүүгө жардам берем.",
