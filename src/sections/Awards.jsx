            ...
            {displayedResults.map((item, index) => (
              ...
              >
                <div
                  ...
                  className={`group relative flex flex-col rounded-2xl border cursor-pointer transition-all duration-500 overflow-hidden h-full ${
                    item.isGold
                ...
                >
                  {/* Gold Badge */}
                  {item.isGold && (
                    <div className="absolute top-4 right-4 z-20 px-3 py-1 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full text-[9px] font-black text-white uppercase shadow-lg">
                      ★ BEST CASE
                    </div>
                  )}
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div
                        className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase ${item.isGold ? "bg-yellow-500/20 text-yellow-400" : "bg-blue-500/20 text-blue-400"}`}
                      >
                        {item.result}
                      </div>
                    </div>

                    <h3 className="text-xl font-black text-white uppercase leading-tight group-hover:text-blue-400 transition-colors">
                      {item.name}
                    </h3>
                    <p className="text-[10px] font-mono text-pink-400 font-bold mt-1 mb-3">
                      {item.handle}
                    </p>
                    <p className="text-gray-400 text-[11px] leading-relaxed italic mb-4">
                      "{item.description}"
                    </p>
